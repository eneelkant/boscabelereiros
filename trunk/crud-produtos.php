...
class CrudProduto extends Banco {
	...
	{
		this->getQuery("UPDATE boscabelereiros.Produto SET nome=$array['nome'], descricao=$array['descricao'], preco=$array['preco'], imagem=$array['imagem']");
	}
	...
	{
		this->getQuery("INSERT INTO boscabelereiros.Produto VALUES (null, $array['nome'], $array['descricao'], $array['preco'], $array['imagem'])");
	}
}
